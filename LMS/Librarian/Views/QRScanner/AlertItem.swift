...
struct AlertContext {
    ...
    static let invalidJSONFormat = AlertItem(
        ...
        message: "The QR code contains JSON data but not in the expected format. Please ensure it has bookId, memberId, issueStatus, issueDate, and returnDate fields.",
        dismissButton: .default(Text("OK"))
    )
